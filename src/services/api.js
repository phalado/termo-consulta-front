const getWordList = async (state) => {
  ...
  // const url = "http://localhost:3000/api/v1/words/locate";
  ...
  if (searchArray.length) params += "&r_array=" + searchArray;
  if (removeArray.length) params += "&l_array=" + removeArray;
